    ...
    <div class="container">
        <div class="row vh-md-100">
            <div class="col-md-8 col-sm-10 col-12 mx-auto my-auto text-center">
                <h1 class="heading-black text-capitalize">Are you a Job seeker or Employer?</h1>
                <a href='jobseeker.php' class="btn btn-primary d-inline-flex flex-row align-items-center">
                    Job seeker
                    <em ></em>
</a>
<a href='employer.php' class="btn btn-primary d-inline-flex flex-row align-items-center">
                    Employer
                    <em ></em>
</a>
            </div>
